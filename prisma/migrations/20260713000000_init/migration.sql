...
-- CreateEnum
CREATE TYPE "ProposalStatus" AS ENUM ('REVISIONE', 'VOTAZIONE', 'APPROVATA');

-- CreateEnum
CREATE TYPE "VoteTargetType" AS ENUM ('THREAD', 'PROPOSAL', 'POLL');
...
CREATE TABLE "Proposal" (
    ...
    "description" TEXT NOT NULL,
    "authorId" TEXT NOT NULL,
    "status" "ProposalStatus" NOT NULL DEFAULT 'REVISIONE',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "User_tesseraNumero_key" ON "User"("tesseraNumero");
